...
\begin{quotation}
Čím více  \textbf{\texttt{druhů}}, \textit{řezů}, {\tiny velikostí}, {\color{green}barev} písma a~{\color{blue}\textsc{jiných efektů}} \underline{použijeme}, {\color{red}tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
